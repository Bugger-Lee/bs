      ...
      <div class="marketing-theme">
            ...
            <el-submenu index="1">
              ...
              <el-menu-item-group>
                <ul class="theme-l-tmp">
                  <li v-for="i in sourcesType" :key="i.id" class="dragableSources tac">
        ...
        <el-col :span="18" class="marketing-drag">
          <ul class="imaginary" v-if="!ifSmsDrag">
            ...
            <li class="imaginary-square"></li>
            <div v-if="showFirst">
              <div v-if="ifDrag" class="marketing-drag-content">
                <span class="crowd-style" @click="dataExtension()" id="data1">
                ...
                <p>{{propsData.data_socure}}</p>
              </div>
              <div v-if="ifSmsDrag" class="marketing-drag-content">
                <span class="msg-style" @click="sms()" id="return1">
                  <i class="icon-duanxin2-copy" style="font-size:32px;"></i>
                </span>
                <p>SMS</p>
              </div>
              <div v-if="ifProDrag" class="marketing-drag-content">
                <span class="crowds-style"  @click="popupTicket()" id="newreturn" style="background-color:#ffcd43;">
                  <i class="icon-quanyi-copy-copy"></i>
                </span>
                <p>Coupon</p>
              </div>
              <div v-if="ifSmsDrag" class="marketing-drag-content">
                <span class="ctl-style" @click="selectTime()" id="return2">
                  <i class="icon-time1"></i>
                </span>
                <p>Time</p>
              </div>
              <div v-if="ifSmsDrag" class="marketing-drag-content">
                <span class="crowd-style" id="return3">
            ...
            <div v-if="showSecend">
              ...
              <div v-if="ifProDrag" class="marketing-drag-content">
                <span class="crowds-style" @click="popupTicket()"  id="newreturn1" style="background-color:#ffcd43;">
                  <i class="icon-quanyi-copy-copy"></i>
                </span>
                <p>Coupon</p>
              </div>
              <div v-if="ifSmsDrag" class="marketing-drag-content">
                <span class="ctl-style" @click="selectTime()" id="return222">
                  <i class="icon-time1"></i>
                </span>
                <p>Time</p>
              </div>
              <div v-if="ifSmsDrag" class="marketing-drag-content">
                <span class="crowd-style" id="return333">
                  <i class="icon-wancheng1"></i>
                </span>
                <p>Over</p>
              </div>
            ...
            <div v-if="showLast">
              ...
              <div v-if="ifSmsDrag" class="marketing-drag-content">
                <span class="msg-style" @click="sms()" id="return1111">
                  <i class="icon-duanxin2-copy" style="font-size:32px;"></i>
                </span>
                <p>SMS</p>
              </div>
              <div v-if="ifProDrag" class="marketing-drag-content">
                <span class="crowds-style" @click="popupTicket()"  id="newreturn11" style="background-color:#ffcd43;">
                  <i class="icon-quanyi-copy-copy"></i>
                </span>
                <p>Coupon</p>
              </div>
              <div v-if="ifSmsDrag" class="marketing-drag-content">
                <span class="ctl-style" @click="selectTime()" id="return2222">
                  <i class="icon-time1"></i>
                </span>
                <p>Time</p>
              </div>
              <div v-if="ifSmsDrag" class="marketing-drag-content">
                <span class="crowd-style" id="return3333">
                  <i class="icon-wancheng1"></i>
                </span>
                <p>Over</p>
              </div>
            ...
            <div v-if="showFirst1">
              ...
              <div v-if="ifSmsDrag" class="marketing-drag-content">
                <span class="msg-style" @click="sms()" id="return11">
                  <i class="icon-duanxin2-copy"  style="font-size:32px;"></i>
                </span>
                <p>SMS</p>
              </div>
              ...
              <div v-if="ifSmsDrag" class="marketing-drag-content">
                <span class="ctl-style" @click="selectTime()" id="return22">
                  <i class="icon-time1"></i>
                </span>
                <p>Time</p>
              </div>
              <div v-if="ifSmsDrag" class="marketing-drag-content">
                <span class="crowd-style" id="return33">
                  <i class="icon-wancheng1"></i>
                </span>
                <p>Over</p>
              </div>
  ...
  methods: {
    ...
    dragInit() {
      ...
      $(".dragableSources").draggable({
        ...
        stop: function(event, ui) {
          ...
          $('.imaginary-circle').append(event.target)
          // console.log($('.imaginary-circle').append(event.target))
        }
      });
    ...
    appendDiv(left, top,text,code,className) {
      ...
      this.$nextTick(() => {
        ...
        console.log(left, top,text,code,className)
        this.dragLeft = left;
        this.dragTop = top;
        this.dargNext();
      });
